...
2. Browse the page you want to learn more about, then click the Go Horse icon <img src="https://raw.githubusercontent.com/Sitecore-Hackathon/2024-Go-Horse/main/gohorse-chrome-extension/images/icon-128.png" width="32" />
