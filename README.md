...
2. Browse the page you want to learn more about, then click the Go Horse icon <img src="/Sitecore-Hackathon/2024-Go-Horse/raw/main/docs/images/icon-128.png" width="32" />
